...
g++ --std=gnu++17 -Wall -I "C:/Program Files/mingw64/sdl2-w64/include" -I include src/*.cpp -L "C:/Program Files/mingw64/sdl2-w64/lib" -lmingw32 -lSDL2main -lSDL2 -o debug/out
.\debug\out